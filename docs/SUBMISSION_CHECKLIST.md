...
제출 직전에는 공식 [참여 페이지](https://openaigame2026.com/)의 최신 안내와 실제 폼을 함께 확인합니다. Track 1 공개 접수 기간은 2026-08-04–2026-08-26입니다. 공식 FAQ는 마감 전 수정본 재제출과 동일 제출 URL의 게임 업데이트를 허용하지만, 정확한 cutoff와 마감 후 제출 정보 수정·URL 교체 가능 여부는 공개 자료로 확정되지 않았습니다.
...
- [ ] 정확한 접수 cutoff를 countdown이 아닌 공식 근거로 확인했습니다.
- [ ] 마감 후 제출 폼 정보 수정 가능 여부·방법을 공식 근거로 확인했습니다.
- [ ] 마감 후 플레이 URL 교체 가능 여부를 공식 근거로 확인했습니다.
- [ ] T047을 포함한 release·배포·QA·제출의 각 별도 gate를 모두 충족한 뒤 동일한 안정 URL로 현재 후보를 먼저 제출하고, 직접 플레이테스트하며 개선합니다. T061·T047 차단 중에는 release·배포·제출하지 않습니다.
