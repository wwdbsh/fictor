...
T026은 어름의 터, T036은 사름의 터, T037은 흩음의 터, T038은 삭음의 터 콘텐츠 팩을 고정한다. registry는 활성 콘텐츠를
...
`PRESSED_FIRE`, `TOTAL_STOP`, `BLAST`, `BURNOUT`, `SPREADING`, `DISPERSAL`, `NEUTRALIZED`, `SELF_EATING`은 registry에서 실행기가 아니라 기믹
메타데이터로만 보인다.
