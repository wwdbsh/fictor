...
export const SCATTER_GROUND_ENCOUNTERS = SCATTER_GROUND_DESCRIPTOR.encounters!;
export const SCATTER_GROUND_EVENTS = SCATTER_GROUND_DESCRIPTOR.events;
export const SCATTER_GROUND_REWARDS = SCATTER_GROUND_DESCRIPTOR.rewards!;
