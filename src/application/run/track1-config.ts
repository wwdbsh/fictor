...
export const STILLKIN_TRACK1_PROVISIONAL_CONFIG = Object.freeze({
  ...
  combat: Object.freeze({
    ...
    drawCount: 4,
    resonanceRate: 0.1,
    baselineMaterial: Object.freeze({ effectId: "DELAYED_EXPLOSION", cost: 1, power: 10, resonanceAttribute: "STILL" }),
    forgedCard: Object.freeze({ cost: 1, power: 10 }),
  ...
  offers: Object.freeze({
    ...
    fictor: Object.freeze([
      ...
      Object.freeze({ choiceId: "fictor-skip", kind: "SKIP" }),
    ]),
